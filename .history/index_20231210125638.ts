...
app.get('/getReversedPosts' , (req :Request, res:Response)=>{
    ...
    //     for(let j : number = 0 ; j<reversedPost.length-i -1 ; j++){
    //         swapedPost =  reversedPost[j]
    //         reversedPost[j].title = reversedPost[j + 1].title;  
    //         reversedPost[j+1].title = swapedPost.title;
    //         reversedPost[j].body = reversedPost[j + 1].body;  
    //         reversedPost[j+1].body = swapedPost.body;
    //     }
    //  }
